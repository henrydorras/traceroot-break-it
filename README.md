...
[geo-tracker](https://github.com/henrydorras/geo-tracker) measures which observability tools answer engines cite for 250 real agent-debugging questions. TraceRoot's baseline is 1 of 250. Posts like this one are how that number moves.
